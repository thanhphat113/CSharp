...
namespace Doanqlchdt.GUI
{
    ...
    {
        static taikhoanbus bus = new taikhoanbus();
        ...
        public void loadlistview()
        {
            ...
            listView1.Columns.Add("Mã TK", 100, HorizontalAlignment.Left); // Thêm các cột vào ListView
            listView1.Columns.Add("Username", 150, HorizontalAlignment.Left);
            listView1.Columns.Add("Mật Khẩu", 150, HorizontalAlignment.Left);
            listView1.Columns.Add("Mã Quyền", 200, HorizontalAlignment.Left);
            listView1.Columns.Add("Tên Quyền", 100, HorizontalAlignment.Left);
        ...
        public void loadtable()
        {
            ...
            foreach (TAIKHOANDTO tkdto in ds)
            {

                ListViewItem ls = new ListViewItem(tkdto.Matk.ToString());
                ls.SubItems.Add(tkdto.Username);
                ls.SubItems.Add(tkdto.Password);
                ls.SubItems.Add(tkdto.Quyen.ToString());
                ls.SubItems.Add(tkdto.Tenquyen);
        ...
        //THAY ĐỔI double click chuột vào bảng CHI TIẾT
        private void listView1_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            if (listView1.SelectedItems.Count > 0)
            {
                ...
                {
                    if (taikhoandto.Matk.ToString() == selectedMa)
                    {
                        tkdto=taikhoandto;
                    }
                }
