...
{
    public partial class Chitietdonban : Form
    {
        static chitietdonbanbus bus=new chitietdonbanbus();
        static hoadonbandto hdbdto = null;
        ...
        public Chitietdonban(hoadonbandto selectedhd)
        {
            InitializeComponent();
            hdbdto = selectedhd;
            ma = hdbdto.Mhdb;
        ...
        public void loadtable()
        {
            ...
            foreach (chitietdonbandto ct in ds)
            {
