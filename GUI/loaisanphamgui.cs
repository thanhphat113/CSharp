...
{
    public partial class loaisanphamgui : Form
    {
        ...
        public void loadlistview()
        {
            ...
            listView1.Columns.Add("Mã Loại", 100, HorizontalAlignment.Left); // Thêm các cột vào ListView
            listView1.Columns.Add("Tên Loại", 150, HorizontalAlignment.Left);
        ...
        public void loadtable()
        {
            ...
            foreach (loaisanphamdto lsdpdto in ds)
            {

                ListViewItem ls = new ListViewItem(lsdpdto.Maloai);
                ls.SubItems.Add(lsdpdto.Tenloai);
        ...
        private void listView1_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            if (listView1.SelectedItems.Count > 0)
            {
                ...
                {
                    if (loaispdto.Maloai == selectedMa)
                    {
                        lspdto=loaispdto;
                    }
                }
                if (lspdto != null)
                {
                    ...
                    editloaisp editloai=new editloaisp(lspdto);
                    editloai.StartPosition = FormStartPosition.CenterParent;
                    editloai.ShowDialog();
                    if (temppage == true)
                    {
                        loadtable();
        ...
        {
            themloaisp them = new themloaisp();
            them.ShowDialog();
        }
